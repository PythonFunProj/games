...
def main():
    ...
    class Planes(pygame.sprite.Sprite):
        def __init__(self, speed, damage, life, maneuverabilityton, overheat2, shoot):
            super().__init__()
            self.y = 0
            self.x = 0
            self.teta = 0
            ...
            self.shoot = shoot
            self.damage = damage
            self.maneuverability = maneuverabilityton
    ...
    player2 = Planes(5, 4, 100, 0.025, 1, shoot2)
